...
public class Quiz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jProgressBar1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.valor += 10;
        jProgressBar1.setValue(this.valor);
           ...
           if(jRadioButton4.isSelected()){
                if(jRadioButton4.getText().equals(correto)){
                   if(p == 13){
                    ...
                    JOptionPane.showMessageDialog(null,"Errou kkkkkkkkk");
                    JOptionPane.showMessageDialog(null,"Pontuação: "+pontostotal);
                    new Tela().setVisible(true);
                    dispose();
